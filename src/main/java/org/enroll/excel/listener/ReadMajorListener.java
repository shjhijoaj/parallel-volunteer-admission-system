...
public class ReadMajorListener extends AnalysisEventListener<ExcelMajor> {
    ...
    // 与 ReadStudentListener 同理：监听器必须是无状态共享的实例字段，
    // 使用 static 会在并发导入时互相污染数据。
    private final List<ExcelMajor> list = new ArrayList<>();
    ...
    private final Map<String, Integer> departmentIds = new HashMap<>();
